...
import numpy as np
import sox
from utilities import (TargetProcessor, create_folder, int16_to_float32,
                       pad_truncate_sequence, plot_waveform_midi_targets,
                       traverse_folder, write_events_to_midi)
...
class MaestroDataset(object):
    ...
    def __getitem__(self, meta):
        ...
        note_shift = self.random_state.randint(
            low=-self.max_note_shift, high=self.max_note_shift + 1
        )
        ...
        with h5py.File(hdf5_path, "r") as hf:
            ...
            if note_shift != 0:
                ...
                waveform = librosa.effects.pitch_shift(
                    waveform, self.sample_rate, note_shift, bins_per_octave=12
                )
