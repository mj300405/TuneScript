...
from data_generator import (Augmentor, MaestroDataset, Sampler, TestSampler,
                            collate_fn)
...
from utilities import (RegressionPostProcessor, StatisticsContainer,
                       create_folder, create_logging, get_filename)
    ...
    for batch_data_dict in train_loader:
        ...
        if iteration % 5000 == 0:  # and iteration > 0:
            ...
            statistics_container.append(
                iteration, evaluate_train_statistics, data_type="train"
            )
            statistics_container.append(
                iteration, validate_statistics, data_type="validation"
            )
...
if __name__ == "__main__":
    ...
    parser_train.add_argument(
        "--augmentation", type=str, required=True, choices=["none", "aug"]
    )
